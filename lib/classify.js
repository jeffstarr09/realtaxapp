...
const RULES = [
  ...
  },
  {
    ...
    keywords: [
      ...
      "openai", "chatgpt", "chat gpt",
      "perplexity", "cursor ai", "cursor sh", "cursor.sh",
      "runway ml", "runwayml", "elevenlabs", "eleven labs",
      "github copilot",
    ],
    deductible: "Yes", confidence: 0.85,
    reason: "AI tool / software subscription (marketing content, research, productivity)",
  },
  {
  ...
  },
  {
    ...
    keywords: [
      "pg&e", "pge ", "socalgas", "so cal gas", "edison", "sce ",
      "con edison", "con ed", "coned", "consolidated edison",
      "nyseg", "national grid", "duke energy", "dominion",
      "dwp", "la dwp", "ladwp",
      "water dept", "water department", "water bill", "water utility",
      "dep of water", "water authority", "water & sewer", "water and sewer",
      "city of ", "sewer dept", "sewer bill",
    ],
    deductible: "Review", confidence: 0.8,
    reason: "Utilities — allocate by home office % + rental unit % of square footage (electric paid for tenants is typically fully deductible against rental income)",
  },
  {
